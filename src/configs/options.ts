module.exports = {
  ...
  (в приведенном примере удалятся слова со следующими номерами: 3, 5, 6, 7, 1)`,
    ...
    test_text: 
    "Вы начали проверку знаний слов из вашего словаря. Я буду отправлять вам слова, а вам будет нужно будет писать переводы этих слов. До того момента, пока вы не напишете одно слово правильно дважды подряд, оно не будет помечено как проверенное(проверенные пары слов помечаются галочкой ✅ при просмотре словаря).",
